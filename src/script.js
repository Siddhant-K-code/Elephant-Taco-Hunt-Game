...
const App = React.createClass({
  ...
  _handleSoundChange: function () {
    ...
    fullAudio.muted = audioIncrease.muted = audioDecrease.muted = audioMargarita.muted = !this
      .state.isMuted;
    ...
    return /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        "div",
        {
          ...
          onClick: this._handleSoundChange
        },
      ...
      /*#__PURE__*/ React.createElement(Controls, {
        _updateScore: this._updateScore,
      ...
      /*#__PURE__*/ React.createElement(Opener, {
        startGame: this.startGame
      }),
      /*#__PURE__*/ React.createElement(Won, {
        _isGameWon: this._isGameWon,
        startGame: this.startGame,
        finalScore: this.state.finalScore
      }),
      /*#__PURE__*/ React.createElement(Lost, {
        _isGameLost: this._isGameLost,
        startGame: this.startGame
      })
    );
  }
...
const Controls = React.createClass({
  ...
  _flyBy: function (el, amt, name, delay) {
    ...
    let obj = {},
      ...
      randY = Math.random() * (offset - 1) + 1; //randY = amt * 50; this is for testing
  ...
  componentDidMount: function () {
    ...
    (function getCoords() {
      ...
      function intersectRect(a, b) {
        return (
          Math.max(a.left, b.left + 40) < Math.min(a.right, b.right - 40) &&
    ...
    return /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        ...
        /*#__PURE__*/ React.createElement(
          ...
          {
            id: "up",
            onClick: this._elephantDirection.bind(this, "up")
          },
          ...
          /*#__PURE__*/ React.createElement("path", {
            d:
              "M138.7 50.4h-4.4L144 44l8.4 5.5-1.4.9h-3.1v6.5l-1.4.9h-7.8zm-1.3-.9h2.6v7.4h5.2v-7.4h2.6l-5.2-3.4z",
            fill: "#000"
          })
        ),
        /*#__PURE__*/ React.createElement(
          ...
          {
            id: "right",
            onClick: this._elephantDirection.bind(this, "right")
          },
          /*#__PURE__*/ React.createElement("path", {
            fill: "#fff",
            d: "M160.8 71.6l4.6-7.5-4.6-7.6v3.1h-7.5v6.6h7.5v5.4z"
          }),
          /*#__PURE__*/ React.createElement("path", {
            d:
              "M159.9 58.6v-4.7l6.4 10.4-5.5 8.9-.9-1.5v-3.2h-6.5l-.9-1.5v-8.4zm.9-1.4V60h-7.4v5.6h7.4v2.8l3.4-5.6z",
            fill: "#000"
          })
        ),
        /*#__PURE__*/ React.createElement(
          ...
          {
            id: "down",
            onClick: this._elephantDirection.bind(this, "down")
          },
          /*#__PURE__*/ React.createElement("path", {
            fill: "#fff",
            d: "M150.9 78l-7.1 4.6-7-4.6h2.9v-7.5h6.2V78h5z"
          }),
          /*#__PURE__*/ React.createElement("path", {
            d:
              "M138.8 69.7h7.7l1.4.9v6.5h3l1.4.9-8.3 5.5-9.7-6.4h4.4zm3.9 11.7l5.2-3.4h-2.6v-7.4h-5.2V78h-2.6z",
            fill: "#000"
          })
        ),
        /*#__PURE__*/ React.createElement(
          ...
          {
            id: "left",
            onClick: this._elephantDirection.bind(this, "left")
          },
          /*#__PURE__*/ React.createElement("path", {
            fill: "#fff",
            d: "M126.2 71.6l-4.7-7.5 4.7-7.6v3.1h7.4v6.6h-7.4v5.4z"
          }),
          /*#__PURE__*/ React.createElement("path", {
            d:
              "M134.4 58.6v8.3l-.9 1.5H127v3.3l-.9 1.5-5.5-8.9 6.4-10.4v4.8zm-11.7 4.2l3.4 5.6v-2.8h7.4V60h-7.4v-2.8z",
            fill: "#000"
          })
        )
      ),
      /*#__PURE__*/ React.createElement(
        "div",
        {
          className: "elephantContainer",
          ref: "elContainer"
        },
        /*#__PURE__*/ React.createElement(Elephant, null),
      ...
      /*#__PURE__*/ React.createElement("div", {
        className: "overlay overlayMargarita",
        ref: "overlayM"
      })
    );
  }
  ...
  render() {
    return /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        ...
        /*#__PURE__*/ React.createElement("path", {
          d:
            "M1741.8 197.7c0 109.3-89 197.8-198.8 197.8a198.6 198.6 0 0 1-158.5-78.4H11.2A11.2 11.2 0 0 1 0 305.9V89.5a11.2 11.2 0 0 1 11.2-11.1h1373.4A198.8 198.8 0 0 1 1543 0c109.8 0 198.8 88.5 198.8 197.7z",
          fill: "#000"
        }),
        /*#__PURE__*/ React.createElement("path", {
          d:
            "M1591.8 127c-18.3 0-34.1 14.8-41.4 30.3-7.3-15.5-23.1-30.3-41.4-30.3a45.7 45.7 0 0 0-45.7 45.5c0 51.1 51.8 64.5 87.1 115.1 33.4-50.2 87.1-65.6 87.1-115.1a45.7 45.7 0 0 0-45.7-45.5z",
          fill: "#b29968"
        }),
        /*#__PURE__*/ React.createElement("rect", {
          x: "68.2",
...
const Won = React.createClass({
  ...
  render() {
    const final = this.props.finalScore,
      twitterURL =
        "https://twitter.com/intent/tweet?text=I+won+at+Elephant+Taco+Hunt+My+score+was+" +
        final +
        "!+You+can+play+here:+https://React-Game-Elephant-Taco-Hunt.siddhantkcode.repl.co&via=Siddhant_K_code";
    return /*#__PURE__*/ React.createElement(
      "div",
      {
      ...
      /*#__PURE__*/ React.createElement("div", {
        className: "overlay overlayWinning"
      }),
      /*#__PURE__*/ React.createElement(
        "div",
        {
        ...
        /*#__PURE__*/ React.createElement(
          ...
          "You got to eat tacos and nobody changed your plans! Super."
        ),
        /*#__PURE__*/ React.createElement(
          "div",
          {
        ...
        /*#__PURE__*/ React.createElement(
          ...
          {
            className: "start",
            onClick: this._handleRestartClick
          },
          "Play again!"
        )
      )
...
const Lost = React.createClass({
  ...
  render() {
    return /*#__PURE__*/ React.createElement(
      "div",
      {
        className: "loseContainer",
        ref: "loseContainer"
      },
      /*#__PURE__*/ React.createElement("div", {
        className: "overlay overlayLosing"
      }),
      /*#__PURE__*/ React.createElement(
        "div",
        {
        ...
        /*#__PURE__*/ React.createElement(
          ...
          "You were overruled and didn't get to eat any tacos. Sounds like you're going to a movie you already saw instead."
        ),
        /*#__PURE__*/ React.createElement("div", {
          className: "hangry-svg"
        }),
        /*#__PURE__*/ React.createElement(
          "button",
          {
  ...
  render() {
    return /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement("path", {
        ...
        className: "st0",
        d:
          "M173.9 62s58.7-16.7 68.3-32.3c9.7-15.7 19.7-11 18-2.7-1.7 8.3-40 49.3-49.7 47.7-9.7-1.7-27.7 7.1-31 0-3.2-7-15.7-9-5.6-12.7z"
      }),
      /*#__PURE__*/ React.createElement("path", {
        className: "st1",
        d:
          "M154.1 117.3s16.5 6.9 18.5 11.2c2 4.2 1.5 6 3.5 5.8s11.2-5.8 8-12.9-23-24.9-28.8-17.4-6.2 12.4-1.2 13.3z"
      }),
      ...
      /*#__PURE__*/ React.createElement("path", {
        className: "st2",
        d:
          "M204.8 63.6s-20.1-29.6-44-11.9c0 0-3.9-3.3-7.3 3.3-4 7.9-5.1 7.3-5.1 7.3s-6-4.2-6.9 10.5c-.8 14.7-15.7 22.5-4.8 26.2 10.8 3.7 31.8-23.7 31.8-23.7s19.7-16.8 36.3-11.7z"
      }),
      /*#__PURE__*/ React.createElement("path", {
        id: "ear-left",
        className: "st0",
        d:
          "M160.3 68.7S111.6 63 64 78.4c0 0-31.3 5.7-35 0 0 0-18.7-5.3-5.7 5.2 0 0 20.3 15.8 55.3 16s60.7-11.2 60.7-11.2l23.7-4.8c-.1-.1 23.3-13.9-2.7-14.9z"
      }),
      /*#__PURE__*/ React.createElement(
        "g",
        {
      ...
      /*#__PURE__*/ React.createElement("path", {
        className: "st1",
        d:
          "M162.3 129s-4.2-.8-6-8c-1.8-7.2-2-18-13-17s-12.5 8.8-12.5 8.8-4 6.7 7.5 17.2c0 0 2.7 1.8 3.6 6.5 1.5 8.1 20.4-7.5 20.4-7.5z"
      }),
      /*#__PURE__*/ React.createElement("ellipse", {
        transform: "rotate(-20.12 152.072 132.685)",
        className: "st1",
        cx: "152.1",
        cy: "132.7",
        rx: "10.9",
...
const Opener = React.createClass({
  ...
  render() {
    return /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement("div", {
        className: "overlay overlayOpener"
      }),
      /*#__PURE__*/ React.createElement(
        "div",
        {
...
var controlsMQ = document.getElementById("touch-controls"),
  ...
  endsvgMQ = document.querySelectorAll("div.award, div.hangry-svg"); // media query event handler
